...
(function(){
  ...
  replacer = function(input, node, queryEngine){
    return function(arg$, replacementArg){
      var ref$, selector, filters, origResults, e, results, rawPrepend, rawAppend, join, filterName, argsStr, args, that, i$, len$, arg, pre, post, result, n, len, rawResults, res$;
