...
(function(){
  ...
  getRaw = function(input, node){
    var that, ref$, ref1$, startLine, startCol, endLine, endCol, area, areaLast;
    if (that = node.raw) {
      return that;
    }
  ...
  replace = function(replacement, input, nodes, queryEngine){
    var origInputLines, inputLines, colOffset, lineOffset, lastLine, prevNode, i$, len$, node, ref$, start, end, startLineNum, endLineNum, numberOfLines, startCol, endCol, replaceLines, startLine, endLine, startContext, endContext, replaceLast, endLen;
